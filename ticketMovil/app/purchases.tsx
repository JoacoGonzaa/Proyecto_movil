  ...
  return (
    <View className="flex-1 bg-gray-50" style={{ paddingTop: insets.top }}>
      ...
      <View className="flex-row items-center justify-between px-5 mb-4 pt-2">
        <View className="flex-row items-center">
            <Text className="text-2xl font-extrabold text-gray-900">Mis Compras</Text>
        </View>

        {purchases.length > 0 && (
            <TouchableOpacity onPress={handleClearHistory} className="bg-red-50 p-2.5 rounded-full border border-red-100">
